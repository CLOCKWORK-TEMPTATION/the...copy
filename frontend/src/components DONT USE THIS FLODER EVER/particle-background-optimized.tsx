...
import type {
  ...
  ParticlePosition,
  EffectConfig,
} from "@/components DONT USE THIS FLODER EVER/particle-effects";
import {
  applySparkEffect,
  applyWaveEffect,
  applyVortexEffect,
...
} from "@/components DONT USE THIS FLODER EVER/device-detection";
import {
  BASELINE,
  STROKE_WIDTH,
  X_HEIGHT,
  ...
  SAMPLING_BOUNDS,
  PARTICLE_THRESHOLDS,
} from "@/components DONT USE THIS FLODER EVER/particle-letters.constants";
