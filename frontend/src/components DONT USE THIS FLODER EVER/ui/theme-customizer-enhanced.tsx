...
import { Dialog, DialogContent, DialogHeader, DialogTitle } from "@/components DONT USE THIS FLODER EVER/ui/dialog";
import { Tabs, TabsList, TabsTrigger, TabsContent } from "@/components DONT USE THIS FLODER EVER/ui/tabs";
